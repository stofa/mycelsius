...
const icons = Object.freeze({ eth, btc, dash, bch, bsv, ltc, zec, btg, xrp, xlm, omg, tusd, gusd, pax, usdc, dai, zrx, cel, mcdai, orbs, usdterc20, tgbp, taud, thkd, tcad, eos, sga, xaut, etc, bat, busd });
;
